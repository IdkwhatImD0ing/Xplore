    ...
    [
      [
        ...
        },
        {
          ...
          endLocation :
              {name : 'Innovation Fountain', address : '503 Innovation Ave'},
          route : [
        ...
        {
          startLocation :
              {name : 'Heritage Monument', address : '104 Heritage St'},
          endLocation :
              {name : 'University Campus', address : '504 University Ave'},
          route : [
        ...
        },
        {
          ...
          endLocation :
              {name : 'Lighthouse Tower', address : '505 Lighthouse Ave'},
          route : [
      ...
      [
        ...
        {
          startLocation :
              {name : 'Innovation Square', address : '113 Innovation St'},
          endLocation :
              {name : 'Fountain Square', address : '613 Fountain Ave'},
          route : [
